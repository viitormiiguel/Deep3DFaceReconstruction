...
def parse_args():
	...
	parser.add_argument('-i', '--inputpath', default='TestSamples/examples', type=str, help='path to the test data, can be image folder, image path, image list, video')
	parser.add_argument('-s', '--savefolder', default='TestSamples/examples/results', type=str, help='path to the output directory, where results(obj, txt files) will be stored.')
...
def demo():
	...
	# image_path = 'E:/PythonProjects/tesis-app/data/input'
	# save_path = 'E:/PythonProjects/tesis-app/data/output/retDeep'
